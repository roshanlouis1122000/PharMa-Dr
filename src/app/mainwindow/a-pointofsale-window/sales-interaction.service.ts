...
export class SalesInteractionService {
  ...
  addSales( drugName: Array<any> =[], totalPrice: number, tax: number, paidAmount: number, balance: number) {
    ...
    this.http.post<{message: string, salesId: string}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/sales',sales)
  ...
  getSales() {
    this.http.get<{message: string, sales: any}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/sales')
    .pipe(map(salesData => {
  ...
  getSalesChartInfo2():Observable<any>{
    ...
    return this.http.get<{ message: string,sales:any}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/sales/getSalesChartInfo');
   ...
   getSalesChartInfo(){
    console.log("service")
    this.http.get<{message: string, sales: any}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/sales/getSalesChartInfo')
    .pipe(map(salesData => {
     return salesData.sales.map(sales=>{
       return{
        // drugName: sales.drugName,
  ...
  //   this.http
  //            .put('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/supplier/' + id , supplier)
  //            .subscribe(response => {
