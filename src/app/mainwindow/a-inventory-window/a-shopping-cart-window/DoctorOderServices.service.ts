...
export class DoctorOderServices{
  ...
  createDoctorUser(doctorName: string , doctorContact: string , doctorId: string ,doctorEmail: string ,drugId: Array<any> = [] ,drugName: Array<any> = [],drugPrice: Array<any> = [] ,drugQuantity: Array<any> = [] ,realQuantity: Array<any> = [] ,totalAmount: number,pickupDate: string){
    ...
    this.http.post("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/doctorOder",DoctorOderData)
      .subscribe(response =>{
  ...
  createVerifiedDoctorOder(doctorName: string,doctorEmail: string,doctorId: string ,totalAmount: number,pickupDate: string,drugId: Array<any> = [] ,drugName: Array<any> = [],drugPrice: Array<any> = [] ,drugQuantity: Array<any> = [],realQuantity: Array<any> = [] ,doctorContact: string){
    const VerifiedDoctorOderData  = {doctorName:doctorName ,
                            ...
                            totalAmount:totalAmount,
                            pickupDate:pickupDate};
    this.http.post("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/verifiedDoctorOder",VerifiedDoctorOderData)
      .subscribe(response =>{
        console.log(response);
      });
  ...
  createPickedUpDoctorOder(doctorName: string,doctorEmail: string,doctorId: string ,totalAmount: number,pickupDate: string, drugId: Array<any> = [], drugName: Array<any> = [],drugPrice: Array<any> = [] ,drugQuantity: Array<any> = [] ,doctorContact: string){
    const PickedUpDoctorOderData  = {doctorName:doctorName ,
                            ...
                            totalAmount:totalAmount,
                            pickupDate:pickupDate};
    this.http.post("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/pickedUpOders",PickedUpDoctorOderData)
      .subscribe(response =>{
        console.log(response);
      });
  ...
  getDocOders() {
    this.http.get<{message: string, doctorOders: any}>("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/doctorOder")
  ...
  getVerifiedDocOders() {
    this.http.get<{message: string, doctorOders: any}>("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/verifiedDoctorOder")
    .pipe(map(docOderData => {
     return docOderData.doctorOders.map(doctorOder => {
       return{
        doctorName : doctorOder.doctorName ,
  ...
  getPickedUpDocOders() {
    this.http.get<{message: string, doctorOders: any}>("http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/pickedUpOders")
    .pipe(map(docOderData => {
     return docOderData.doctorOders.map(doctorOder => {
       return{
        doctorName : doctorOder.doctorName ,
  ...
  deleteItem(oderId: string) {
    this.http.delete('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/doctorOder/' + oderId)
      .subscribe(() =>{
  ...
  deleteVerifiedItem(oderId: string) {
    this.http.delete('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/verifiedDoctorOder/' + oderId)
      .subscribe(() =>{
        const inventoryUpdated = this.docOders.filter(order => order.id !== oderId);
        this.docOders = inventoryUpdated;
        this.docOdersUpdated.next([...this.docOders])
