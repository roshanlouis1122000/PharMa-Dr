...
export class SupplierInteractionService {
  ...
  getSupplier() {
    this.http.get<{message: string, suppliers: any}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/supplier')
  ...
  getSuppiers(id: string){
    ...
    ('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/supplier/' + id);
  }
  ...
  addSupplier( supplierID: string, name: string, email: string, contact: string, drugsAvailable: string) {
    ...
    this.http.post<{message: string, supplierId: string}>('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/supplier',supplier)
  ...
  deleteSupplier(supplierId: string) {
    this.http.delete('http://pharmacymanagement-env.eba-kkvmvp8x.us-east-1.elasticbeanstalk.com/api/supplier/' + supplierId)
      .subscribe(() => {
